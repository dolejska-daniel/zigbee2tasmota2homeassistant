...
class HumiditySensorExtractor(ProcessorBase):

    class Meta:
        type = ProcessorType.EntityDiscovery

    def __init__(self, *args, **kwargs):
        self.source_property_name = kwargs.pop("source_property_name", "Humidity")
    ...
    def process(self, *args, device_id: str, mqtt_source_topic: str, entity: Entity, **kwargs):
        ...
        entity.topic_meta.object_id = "humidity"
        ...
        entity.unique_id = f"sensor/{mqtt_source_topic}/{device_id}/humidity"
